        ...
        <section class="portfolio-block project-no-images">
            <div class="container">
                ...
                <div class="content">
                                    ...
                                    if (this.readyState == 4 && this.status == 200) {
                                        ...
                                        for (var team of teams) {
                                            ...
                                            for (var objective of objectives) {
                                                ...
                                                if (objective_data["type"] == "photo" && objective_data["completed"]){
                                ...
                                methods: {
                                    updateLeaderboard(){
                                        ...
                                        .then((response) => {
                                            ...
                                            if(json != ''){
                                                var huntSessionData = JSON.parse(json);
                                                console.log(huntSessionData["teams"]);
                                                var teams = Object.keys(huntSessionData["teams"]);
                                                for (var team of teams){
                                                    if(team!=''){
                                                        console.log(team);
                    ...
                    <!--<?php echo '<form action="api/endsession.php?pin="'. $_GET['sessionID'] .'">'; ?>-->
                        <button class="btn btn-primary" type="submit">End Game</button>
                    <!--</form>-->
