    ...
    function displayInfo($conn)
    {
        ...
        if (mysqli_stmt_prepare($stmt, $sql)) {
            ...
            while ($row = mysqli_fetch_assoc($data)) {
                ...
                $verified = htmlspecialchars($row['Verified']);
            }
        }
        mysqli_stmt_close($stmt);

        //Displays information of the user
        echo "<div class='card mx-auto' style='max-width: 18rem'><div class='card-body'>";
        ...
        if (mysqli_stmt_prepare($stmt, $huntSQL)) {
            ...
            echo "<div class='card mx-auto' style='max-width: 650px'><div class='card-body'>";
            echo "<h3>My Hunts</h3>";
